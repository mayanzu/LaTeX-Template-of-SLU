...
\noindent{\heiti 关键词：}遗传算法；自动排课；约束满足；冲突检测；Streamlit
...
\noindent\textbf{Keywords：}Genetic Algorithm; Course Scheduling; Constraint Satisfaction; Conflict Detection; Streamlit
